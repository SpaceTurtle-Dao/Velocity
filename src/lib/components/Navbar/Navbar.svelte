...
<Router {url}>
    ...
    <aside class="shadow-lg flex flex-col justify-between p-0">
        <div class="space-y-5">
            <!-- secondarysecondary -->
            <div class="p-2">
                <svg
                    ...
                    {#if profile}
                        ...
                        <div>
                            ...
                            <p class="text-secondary-200">
                                <!-- @{profile.username} {/* Use `username` instead of `name` */} -->
                            </p>
                            <!-- <p class="mt-2 text-white">{profile.bio}</p> {/* Remove quotes */} -->
                        </div>
                    {:else}
                        <div class="flex items-center space-x-4">
    ...
    <!-- Add a main section for your routes -->
    <!-- </div> -->
</Router>
