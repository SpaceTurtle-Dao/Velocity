...
<div
  class="min-h-screen bg-background flex items-center justify-center p-4 sm:p-6 md:p-8"
>
    ...
    <CardContent>
      <form on:submit|preventDefault={() => {}} class="space-y-6">
        ...
        <div class="flex flex-col items-center -mt-16 mb-8">
          ...
          <span class="text-sm text-muted-foreground mt-2">Profile picture</span
          >
        </div>
        <div class="grid gap-6">
          ...
          <div class="space-y-2">
            ...
            {#if errors.display_name}
              <p class="text-destructive text-sm mt-1">{errors.display_name}</p>
            {/if}
          </div>
