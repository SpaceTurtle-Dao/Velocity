            ...
            {#each memes as meme (meme.Pool)}
                <Link to="/Feed/{meme.Pool}" class="block">
                    ...
                    >
                        ...
                        <CardContent
                            class="p-3 flex-grow overflow-hidden bg-white"
                        >
                            {#if meme.Post.Kind == "0"}
                                <p
                                    class="text-sm mb-2 line-clamp-3 text-gray-700"
                                >
                                ...
                                <img
                                    alt="Meme content"
                                    src={toUrl(
                                        JSON.parse(meme.Post.Content).media,
                                    )}
                        ...
                        <div
                            class="flex justify-between w-full px-3 py-2 bg-white"
                        >
                            <Pump {meme} />
                            <Dump {meme} />
                        </div>
