...
<div class="max-w-2xl mx-auto p-4 space-y-6 mt-5">
  <div class="flex items-center space-x-4 bg-background-700 rounded-full p-3">
  ...
  {:else if searchQuery}
    <p class="text-center text-muted-foreground">No profiles found</p>
  {/if}
</div>