...
{#if isOpen}
  ...
  >
    <div
      class="bg-gradient-to-r from-indigo-600 to-purple-600 p-1 rounded-2xl w-full max-w-lg shadow-lg"
    >
      <div
        class="bg-white rounded-xl p-6 space-y-6 overflow-y-auto max-h-[80vh]"
      >
        ...
        <form on:submit|preventDefault={create_meme} class="space-y-4">
          ...
          {:else}
            <div
              class="flex justify-center items-center border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50"
            >
              <Button
                variant="ghost"
...
{#if showSuccessMessage}
  <div
    class="fixed bottom-4 right-4 bg-green-500 text-white rounded-lg shadow-lg p-4 flex items-center space-x-2 z-50"
  >
